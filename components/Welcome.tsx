  ...
  evaluation: [
    {
      ...
      icon: Target,
      badge: "Objective",
      body: "Convert learning into observable workplace behaviour."
    },
    {
      title: "Survey Questions",
      icon: BarChart3,
      badge: "Transfer Check",
      body: "Measure what was applied, how often, how confidently, and with what barriers."
    },
    {
    ...
    },
    {
      ...
      icon: BadgeCheck,
      badge: "Decision",
      body: "Compare actual data against pre-determined targets and recommend corrective action."
    }
  ]
};
...
export function Welcome({ mode, onModeChange, onStart }: WelcomeProps) {
  ...
  return (
    <div className="space-y-6">
            ...
            <div className="mt-6 grid gap-3 text-sm font-semibold text-white/75 sm:grid-cols-2">
              <div
                className={cn(
                  ...
                  mode === "evaluation" && "border-[#5d7896]/45 bg-[#10263d]/[0.72]"
                )}
              >
            ...
            return (
              <motion.article
                ...
                className={cn(
                  ...
                  mode === "evaluation" &&
                    "border-[#5d7896]/45 bg-[#081725] text-white shadow-[0_18px_48px_rgba(2,10,22,0.26)] hover:border-[#8ec2f4]"
                )}
              >
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <div className="flex flex-wrap items-center gap-3">
                      <h3 className={cn("text-xl font-bold text-navy-900", mode === "evaluation" && "text-white")}>
                        {card.title}
                      </h3>
                      <Badge>{card.badge}</Badge>
                    </div>
                    <p className={cn("mt-2 text-lg leading-7 text-slate-700", mode === "evaluation" && "text-white/[0.78]")}>
                      {card.body}
                    </p>
                  </div>
                </div>
      ...
      {mode === "evaluation" ? <EvaluationEvidenceChain /> : null}
      ...
      <section className="grid gap-4 xl:grid-cols-[1fr_1fr_0.95fr]">
          ...
          >
            <div className="flex gap-3">
              ...
              <div>
                ...
                <p className={cn("mt-2 text-lg leading-8 text-slate-700", mode === "evaluation" && "text-white/[0.78]")}>
        ...
        <QRCodeAccessCard
          ...
          title={
            mode === "evaluation"
              ? "Scan to Access Evaluation Lab"
              : "Scan to Open Workspace"
          }
          subtitle="Open one workspace per group."
          variant={mode === "evaluation" ? "evaluation" : "default"}
        />
      </section>
      ...
      >
        {mode === "evaluation" ? content.productCredit : PREPARED_BY}
      </footer>
    </div>
  );
}
