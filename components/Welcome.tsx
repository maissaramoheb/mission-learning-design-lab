  ...
  return (
    <div className="space-y-8">
      <section className="grid gap-6 lg:grid-cols-[1.05fr_0.95fr] lg:items-stretch">
        <div className="relative overflow-hidden rounded-[2rem] border border-navy-900/10 bg-navy-900 p-7 text-white shadow-command md:p-10">
          ...
          <div className="relative">
            ...
            <h2 className="mt-6 max-w-4xl text-5xl font-bold leading-tight md:text-6xl">
              {APP_TITLE}
            </h2>
            <p className="mt-5 max-w-3xl text-2xl leading-10 text-un-line">
            ...
            <div className="mt-8 grid gap-3 text-sm font-semibold text-white/75 sm:grid-cols-2">
          ...
          {theories.map((theory, index) => {
            ...
            return (
              <motion.article
                ...
                className="group rounded-[1.5rem] border border-field-border bg-white p-5 shadow-sm transition hover:-translate-y-1 hover:border-un-line hover:shadow-command"
              >
                <div className="flex items-start gap-4">
                  <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl border border-un-line bg-un-light text-un-blue transition group-hover:scale-105">
